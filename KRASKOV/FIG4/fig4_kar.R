...
#D<-TE(x1[i,95000:100000],y1[i,95000:100000])
return(c(A,B,C,D))}
################### 1000 time units ############
...
lines(cp[2:15],result4[2:15,2],type="l",col="blue",lwd=2.5)
lines(cp[2:15],result4[2:15,3],type="l",col="green",lwd=2.5)
lines(cp[2:15],NS[2:15],type="l",col="black",lwd=2.5)
...
legend("topright",legend=c("I(Yt,{Xt-1,Yt-1})","I(Yt;Xt-1)","I(Yt;Yt-1)","Net Synergy"),col=c("red","blue","green","black"),lty=1,lwd=1.4,bty="n",cex=1.4)
