...
source("MMI_function_own.R")
source("JMI_function_own.R")
#source("TE_mean.R")
#source("TE_sd.R")
...
E<-MMI(x[i,94999:99999],x[i,95000:100000],y[94999:99999])
G<-JMI(x[i,95000:100000],x[i,94999:99999],y[94999:99999])
...
#lines(cp[1:9],IXY[1:9],type="o",col="black",lwd=2.5)
