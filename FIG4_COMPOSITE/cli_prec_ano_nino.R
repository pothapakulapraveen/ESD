...
lx_cnrm_lim<-which(lx_cnrm>40 & lx_cnrm<120)
...
lx_giss_lim<-which(lx_giss>40 & lx_giss<120)
...
lx_ipsllr_lim<-which(lx_ipsllr>40 & lx_ipsllr<120)
...
lx_ipslmr_lim<-which(lx_ipslmr>40 & lx_ipslmr<120)
