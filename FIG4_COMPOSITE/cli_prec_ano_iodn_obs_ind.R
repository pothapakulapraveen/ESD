...
se<-seq(-60,60,120/12)
par(mar=c(3,6,3,6))
image(lx_occ[lx_occ_lim],ly_occ[ly_occ_lim],PC_obs_lani-OCCM,xlab=~degree~E,ylab=~degree~E,main='',col=colorss,breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
...
#se<-seq(-60,60,120/12)
par(mar=c(3,4,3,6))
image(lx_aph[lx_aph_lim],ly_aph[ly_aph_lim],PC_obs_lani_aph-APHM,xlab=~degree~E,ylab=~degree~N,main='',col=colorss,breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
...
##########
par(mar=c(3,4,5,6))
image.plot(lx_nce[lx_nce_lim],ly_nce[ly_nce_lim],PC_obs_lani_nce-NCEM,xlab=~degree~E,ylab=~degree~N,main='',col=colorss,breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
