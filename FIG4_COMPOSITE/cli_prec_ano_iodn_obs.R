...
se<-seq(-60,60,120/12)
par(mar=c(3,4,5,4))
image(lx_occ[lx_occ_lim],ly_occ[ly_occ_lim],PC_obs_lani-OCCM,xlab=~degree~E,ylab=~degree~N,main='GPCC',col=colorss,breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
...
se<-seq(-60,60,120/12)
par(mar=c(3,4,5,4))
image(lx_aph[lx_aph_lim],ly_aph[ly_aph_lim],PC_obs_lani_aph-APHM,xlab=~degree~E,ylab=~degree~N,main='APHRODITE',col=colorss,breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
box(which = "plot", lty = "solid",lwd=1.4)
world.add<-map("world", xlim=range(lx_aph[lx_aph_lim]), ylim=range(ly_aph[ly_aph_lim]),plot=T ,add=TRUE)
map("world2",col="black",lwd=2,interior=T,add=T)
##########
par(mar=c(3,4,5,4))
image.plot(lx_nce[lx_nce_lim],ly_nce[ly_nce_lim],PC_obs_lani_nce-NCEM,xlab=~degree~E,ylab=~degree~N,main='NCEP',col=colorss,breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
box(which = "plot", lty = "solid",lwd=1.4)
