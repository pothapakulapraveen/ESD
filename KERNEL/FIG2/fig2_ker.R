...
A<-CMI(y[i,94999:99999],x[i,95000:100000],x[i,94999:99999],2)
B<-MI(y[i,94999:99999],x[i,95000:100000],2)
C<-MI(x[i,94999:99999],x[i,95000:100000],2)
#return(A)}
return(c(A,B,C))}
################### 1000 time units ############
...
############################################################
cp<-seq(0,1,0.1)
plot(cp[1:9],IXY[1:9]*2,type="l",col="red",lwd=2.5,ylim=c(0,0.4),lty=1,pch=18,xlab="coupling coefficient",ylab="Information exchange (nats)",cex.lab=1.2,cex.axis=1.5,main="Kernel")
