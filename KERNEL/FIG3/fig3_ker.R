...
############################################################
cp<-seq(0,1,0.1)
plot(cp,IXY*2,type="l",col="red",lwd=2.5,ylim=c(0,0.8),lty=1,pch=18,xlab="coupling coefficient",ylab="Information exchange (nats)",cex.lab=1.2,cex.axis=1.5,main="Kernel")
...
lines(cp,result4[,2]*2,type="l",col="blue",lwd=2.5)
lines(cp,result4[,3]*2,type="l",col="green",lwd=2.5)
lines(cp,NS*2,type="l",col="black",lwd=2.5)
