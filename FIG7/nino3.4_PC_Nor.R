...
PC_nor<-  PC
EOF_nor<- EOF*10
save(PC_nor,EOF_nor,file="pc_nino_nor.RData")
#########
...
######## Figure 3 #######
par(mar=c(5,4,5,4))
image.plot(lx_acc[lx_acc_lim],ly_acc[ly_acc_lim],EOF*10,xlab=~degree~E,ylab=~degree~N,main='NorESM1-M EOF1',col=rev(colorss),breaks=se,cex.main=1.4,cex.axis=2,cex.lab=1.4,legend.args=list(text='', side=4, font=2, line=2.5, cex=1))
