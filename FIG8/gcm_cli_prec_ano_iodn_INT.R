...
B71<-apply(MPI1[,,which(PC_mpi<quantile(PC_mpi,0.25))],c(1,2),mean)   * 2592000
B8<-apply(NOR[,,bjja],c(1,2),mean)  * 2592000
B81<-apply(NOR1[,,which(PC_nor<quantile(PC_nor,0.25))],c(1,2),mean)  * 2592000
B9<-apply(EC[,,bjja],c(1,2),mean)  * 2592000
B91<-apply(EC1[,,which(PC_ec<quantile(PC_ec,0.25))],c(1,2),mean)  * 2592000
#########
##############
...
#source("rot_MPI_iodn.R")
#source("rot_NOR_iodn.R")
#source("rot_EC_iodn.R")
#dev.print(postscript,'Fig7a_new_iodn.eps',width=12,height=8)
