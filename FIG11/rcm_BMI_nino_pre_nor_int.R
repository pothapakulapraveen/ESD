...
dir1<-"//gpfs/ahrenshsmfs/user/pothapak/PAPER-2/WAS_22_NCC-NorESM1/"
nc1<-nc_open(paste(dir1,"pr_WAS-22_NCC-NorESM1-M_195101_200512_APH_1.nc",sep=""))
...
PCC2<-PCC1[,,bjja]
#PCC2<-PCC2[,,201:420]
#save(PCC2,file="nor_preprocess.RData")
#load("nor_preprocess.RData")
#load("gpcc_preprocess.RData")
#####  REMOVING NAN Values #####
load("/gpfs/ahrenshsmfs/user/pothapak/PAPER-2/PLOTS/COMPOSITE/pc_nino_nor.RData")
nino<-PC_nor
load("/gpfs/ahrenshsmfs/user/pothapak/PAPER-2/PLOTS/COMPOSITE/iod_PC_Nor_JJAS.RData")
iod<-PC_nor
